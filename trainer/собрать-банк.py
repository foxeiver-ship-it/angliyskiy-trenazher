...
ПОРЯДОК_ТЕМ = [
    ...
    "Простое предложение, придаточные и косвенная речь",
...
def main():
    ...
    # рубрикатор идёт целиком: у темы может ещё не быть вопросов, но уже быть
    # памятка, и номера тем не должны съезжать при пополнении банка
    темы = list(ПОРЯДОК_ТЕМ)
